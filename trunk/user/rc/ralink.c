...
{
#if defined (BOARD_N14U) || defined (BOARD_N11P) || defined (BOARD_MZ_R13) || defined (BOARD_MZ_R13P) || defined (BOARD_CR660x) || defined (BOARD_TX1801) || defined (BOARD_SIMAX1800T)
	return 1;
#else
	return 0;
#endif
...
get_wired_mac_e2p_offset(int is_wan)
{
	...
	return 0xe000;
#elif defined (BOARD_CR660x) || defined (BOARD_Q20) || defined (BOARD_TX1801)
	return 0x3FFFA;
#elif defined (BOARD_SIMAX1800T) 
	return 0x8004;
#else
